...
$Form.MaximumSize = New-Object System.Drawing.Size(720, 600)
...
$Intro.Text = "Dieser Assistent installiert Claude Code, startet den Login und richtet danach das Tray-Icon fÃƒÂ¼r die Claude-Nutzung ein."
$Intro.AutoSize = $false
$Intro.Size = New-Object System.Drawing.Size(650, 44)
$Intro.ForeColor = $ColorTextSecondary
$Intro.Location = New-Object System.Drawing.Point(26, 74)
...
$Card1.Size = New-Object System.Drawing.Size(650, 95)
$Card1.Location = New-Object System.Drawing.Point(26, 130)
Style-Panel $Card1
...
$Step1Title.Location = New-Object System.Drawing.Point(18, 16)
...
$ClaudeStatus.Size = New-Object System.Drawing.Size(410, 42)
$ClaudeStatus.Location = New-Object System.Drawing.Point(18, 44)
...
$InstallClaudeButton.Size = New-Object System.Drawing.Size(160, 36)
$InstallClaudeButton.Location = New-Object System.Drawing.Point(472, 30)
...
$Card2.Size = New-Object System.Drawing.Size(650, 95)
$Card2.Location = New-Object System.Drawing.Point(26, 240)
Style-Panel $Card2
...
$Step2Title.Location = New-Object System.Drawing.Point(18, 16)
...
$LoginStatus.Size = New-Object System.Drawing.Size(410, 42)
$LoginStatus.Location = New-Object System.Drawing.Point(18, 44)
...
$LoginButton.Size = New-Object System.Drawing.Size(160, 36)
$LoginButton.Location = New-Object System.Drawing.Point(472, 30)
...
$Card3.Size = New-Object System.Drawing.Size(650, 95)
$Card3.Location = New-Object System.Drawing.Point(26, 350)
Style-Panel $Card3
...
$Step3Title.Location = New-Object System.Drawing.Point(18, 16)
...
$InstallStatus.Size = New-Object System.Drawing.Size(410, 42)
$InstallStatus.Location = New-Object System.Drawing.Point(18, 44)
...
$InstallButton.Location = New-Object System.Drawing.Point(472, 30)
...
$RefreshButton.Text = "Erneut prÃƒÂ¼fen"
$RefreshButton.Size = New-Object System.Drawing.Size(140, 36)
$RefreshButton.Location = New-Object System.Drawing.Point(26, 480)
...
$ReadmeButton.Text = "Anleitung ÃƒÂ¶ffnen"
$ReadmeButton.Size = New-Object System.Drawing.Size(150, 36)
$ReadmeButton.Location = New-Object System.Drawing.Point(176, 480)
...
$CloseButton.Location = New-Object System.Drawing.Point(476, 480)
# Finish button uses green styling when active, gray when inactive
Style-Button $CloseButton -ActiveBg $ColorGreen -HoverBg [System.Drawing.Color]::FromArgb(5, 150, 105)
...
function Refresh-State {
    ...
    if ($hasCreds) {
        ...
        if (!$hasClaude) {
            $LoginStatus.Text = "Gesperrt. Bitte fÃƒÂ¼hre zuerst Schritt 1 aus."
            $LoginStatus.ForeColor = $ColorTextDisabled
        } else {
            $LoginStatus.Text = "Ausstehend. Bitte logge dich ÃƒÂ¼ber den Button ein."
    ...
    if ($isInstalled) {
        ...
        if (!$hasCreds) {
            $InstallStatus.Text = "Gesperrt. Bitte fÃƒÂ¼hre zuerst Schritt 2 aus."
    ...
    if ($isInstalled) {
        ...
        Set-ButtonEnabled -Button $CloseButton -Enabled $true -ActiveBg $ColorGreen -HoverBg [System.Drawing.Color]::FromArgb(5, 150, 105)
    } else {
        $CloseButton.Text = "Installation beenden"
...
try {
  ...
  Write-Host "Du kannst dieses Fenster jetzt schlieÃƒÅ¸en und im Setup 'Erneut prÃƒÂ¼fen' klicken." -ForegroundColor Gray
} catch {
  Write-Host ""
...
'@
    ...
    Show-Info "Es wurde ein Terminal geÃƒÂ¶ffnet. Warte, bis die Installation dort fertig ist, schlieÃƒÅ¸e das Terminal und klicke hier auf 'Erneut prÃƒÂ¼fen'."
})

$LoginButton.Add_Click({
    $claude = Find-Claude
    if (!$claude) {
        Show-Warn "Claude Code wurde noch nicht gefunden. Bitte zuerst Schritt 1 ausfÃƒÂ¼hren."
        return
    }
...
& "$claude"
Write-Host ""
Write-Host "Wenn der Login fertig ist, dieses Fenster schlieÃƒÅ¸en und im Setup 'Erneut prÃƒÂ¼fen' klicken." -ForegroundColor Gray
"@
    Start-VisiblePowerShellScript -ScriptText $script
})
...
$CloseButton.Add_Click({
    ...
    if ($isInstalled) {
        ...
        $result = [System.Windows.Forms.MessageBox]::Show(
            "Die Installation ist noch nicht vollstÃƒÂ¤ndig eingerichtet. MÃƒÂ¶chtest du das Setup wirklich abbrechen?", 
            "Setup abbrechen", 
            "YesNo", 
            "Question"
        )
